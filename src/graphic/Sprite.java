...
public class Sprite {
    ...
    public static Sprite[] bomberImage = { player_up, player_up_1, player_up_2, player_down, player_down_1,
            player_down_2, player_left, player_left_1, player_left_2, player_right, player_right_1, player_right_2,
            player_dead1, player_dead2, player_dead3 };
    /*
     * |--------------------------------------------------------------------------
     * | Character
     * |--------------------------------------------------------------------------
    ...
    public static Sprite[] balloomImage = { balloom_left1, balloom_left2, balloom_left3, balloom_right1,
            balloom_right2, balloom_right3, balloom_dead };
    ...
    public static Sprite[] onealImage = { oneal_left1, oneal_left2, oneal_left3, oneal_right1, oneal_right2,
            oneal_right3, oneal_dead };
    ...
    public static Sprite[] dollImage = { doll_left1, doll_left2, doll_left3, doll_right1, doll_right2, doll_right3,
            doll_dead };
    ...
    public static Sprite[] minvoImage = { minvo_left1, minvo_left2, minvo_left3, minvo_right1, minvo_right2,
            minvo_right3, minvo_dead };
    ...
    public static Sprite[] kondoriaImage = { kondoria_left1, kondoria_left2, kondoria_left3, kondoria_right1,
            kondoria_right2, kondoria_right3, kondoria_dead };
    ...
    public static Sprite[] mobImage = { mob_dead1, mob_dead2, mob_dead3 };
    ...
    public static Sprite[] bombImage = { bomb, bomb_1, bomb_2 };
    ...
    public static Sprite[] explosionImage = { explosion_vertical, explosion_vertical1, explosion_vertical2,
            explosion_horizontal, explosion_horizontal1, explosion_horizontal2, explosion_horizontal_left_last,
    ...
    public static Sprite[] brickImage = { brick, brick_exploded, brick_exploded1, brick_exploded2 };
     ...
     * |--------------------------------------------------------------------------
     */
    public static Sprite bombsImage = new Sprite(DEFAULT_SIZE, 0, 10, SpriteSheet.tiles, 16, 16);
    public static Sprite flamesImage = new Sprite(DEFAULT_SIZE, 1, 10, SpriteSheet.tiles, 16, 16);
    public static Sprite speedImage = new Sprite(DEFAULT_SIZE, 2, 10, SpriteSheet.tiles, 16, 16);
    public static Sprite wallpassImage = new Sprite(DEFAULT_SIZE, 3, 10, SpriteSheet.tiles, 16, 16);
    public static Sprite detonatorImage = new Sprite(DEFAULT_SIZE, 4, 10, SpriteSheet.tiles, 16, 16);
